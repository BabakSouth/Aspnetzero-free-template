...
{
    public abstract class MyProjectNameWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyProjectNameWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyProjectNameWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyProjectNameDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyProjectNameDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyProjectNameDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyProjectNameDbContext, Task<T>> func)
        {
            T result;
