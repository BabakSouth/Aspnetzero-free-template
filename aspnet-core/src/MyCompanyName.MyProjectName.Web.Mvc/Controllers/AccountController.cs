...
using MyCompanyName.MyProjectName.Sessions;
using MyCompanyName.MyProjectName.Web.Models.Account;
using MyCompanyName.MyProjectName.Web.Views.Shared.Components.TenantChange;

namespace MyCompanyName.MyProjectName.Web.Controllers
{
    public class AccountController : MyProjectNameControllerBase
    {
