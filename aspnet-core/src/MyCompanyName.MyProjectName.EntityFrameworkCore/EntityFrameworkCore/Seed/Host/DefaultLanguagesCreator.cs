...
namespace MyCompanyName.MyProjectName.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly MyProjectNameDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = MyProjectNameConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(MyProjectNameDbContext context)
        {
            _context = context;
        }
